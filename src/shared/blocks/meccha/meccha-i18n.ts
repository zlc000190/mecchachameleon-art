...
export const homeCopy = {
  en: {
    ...
    secondScreenItems: [
      ['Faster starts', 'Keep the quick-start checklist handy so you spend less time setting up and more time playing.'],
      ['Friend rooms', 'Use the lobby notes to get friends into the same room with fewer retries and less confusion.'],
      ['Camo practice', 'Review color matching, shadow balance, and route cards before the round begins.'],
    ],
...
const homeCopyOverrides: Record<string, Partial<HomeCopy>> = {
  ...
  th: {
    ...
    newPlayerCards: [
      ['เกมนี้คืออะไร?', 'Meccha Chameleon เป็นเกมซ่อนหาแบบปาร์ตี้บน PC ผู้เล่นฝ่ายซ่อนต้องทาสีตัวเองให้กลืนกับฉากและอยู่ให้นิ่งที่สุด'],
      ['เล่นที่นี่ได้ไหม?', 'ได้ เริ่มจากหน้าต่างเกมบนเบราว์เซอร์ด้านบน แล้วค่อยใช้ไกด์ แผนที่ และจุดซ่อนเป็นหน้าจอที่สอง'],
      ['ต้องดาวน์โหลดก่อนไหม?', 'ไม่จำเป็นสำหรับการลองเล่นครั้งแรก ลองเล่นรอบสั้น ๆ ก่อน ถ้าชอบจังหวะซ่อนตัวและไล่หา ค่อยไปต่อในเวอร์ชันเต็ม'],
      ['ควรเรียนรู้อะไรก่อน?', 'เริ่มจากเลือกจุดซ่อน ดูดสีจากพื้นผิว ปรับท่าทาง และอย่าขยับหลังล็อกตำแหน่ง'],
    ],
    ...
    camoCards: [
      ['อ่านสีพื้นผิว', 'ดูสีหลัก สีเงา และลวดลายของผนัง พื้น ไม้ หรือของตกแต่งก่อนทาตัว'],
      ['ท่าทางที่ไม่สะดุดตา', 'เลือกท่าที่ทำให้เงาและขอบตัวละครไม่ดูเหมือนผู้เล่นที่แปะอยู่บนฉาก'],
      ['ระดับความเสี่ยง', 'แยกจุดง่ายสำหรับมือใหม่ จุดผลตอบแทนสูง และจุดล่อที่ผู้ค้นหามักเช็กก่อน'],
    ],
    ...
    faqs: [
      ['เล่น Meccha Chameleon ออนไลน์ฟรีได้ไหม?', 'ได้ เริ่มจากเกมบนเบราว์เซอร์ด้านบน ไม่ต้องติดตั้งก่อน และใช้หน้านี้ดูแผนที่กับจุดซ่อนได้ทันที'],
      ['มือถือเปิดได้ไหม?', 'เปิดได้บนเบราว์เซอร์สมัยใหม่ แต่ถ้าต้องการประสบการณ์เต็ม แนะนำเล่นบน PC และใช้หน้านี้เป็นหน้าจอที่สอง'],
      ['จุดซ่อนที่ดีควรเป็นแบบไหน?', 'เลือกพื้นที่ที่มีรายละเอียดเยอะ เช่น ชั้นหนังสือ ลายผนัง เงา กล่อง หรือพื้นผิวที่สีไม่เรียบเกินไป'],
      ['หน้านี้เป็นทางการไหม?', 'ไม่ใช่ เป็นเว็บแฟนเมดสำหรับเล่นบนเบราว์เซอร์ ดูไกด์ แผนที่ และเครื่องมือช่วยจำเทคนิค'],
    ],
    secondScreenItems: [
      ['เริ่มเร็วขึ้น', 'เก็บเช็กลิสต์เริ่มเกมไว้ใกล้มือ เพื่อลดเวลาตั้งค่าและเข้าเล่นได้เร็วขึ้น'],
      ['เล่นกับเพื่อน', 'ใช้โน้ตเรื่องห้อง รหัส และการเชิญเพื่อนเพื่อลดความสับสนก่อนเริ่มรอบ'],
  ...
  vi: {
    ...
    newPlayerCards: [
      ['Đây là game gì?', 'Meccha Chameleon là game trốn tìm party trên PC, nơi người trốn sơn cơ thể để hòa vào bản đồ và người tìm săn các silhouette lạ.'],
      ['Có chơi được ở đây không?', 'Có. Bắt đầu bằng khung game trên trình duyệt, rồi dùng hướng dẫn và atlas điểm ẩn làm màn hình phụ khi cần mẹo sâu hơn.'],
      ['Có cần tải ngay không?', 'Chưa cần. Hãy thử một vòng ngắn trước; nếu vòng lặp sơn màu, trốn và bị săn thấy vui thì hãy tiếp tục với bản đầy đủ.'],
      ['Nên học gì đầu tiên?', 'Chọn bề mặt, lấy màu, giữ pose, tránh để viền cơ thể lộ và đứng yên sau khi đã quyết định chỗ trốn.'],
    ],
    ...
    camoCards: [
      ['Đọc màu bề mặt', 'Ghi chú màu chính, vùng sáng, vùng tối và pattern của từng map để sơn không bị lệch tông.'],
      ['Pose và silhouette', 'Nhắc người chơi xoay mặt nào về phía seeker và pose nào ít làm lộ dáng nhất.'],
      ['Mức rủi ro', 'Phân loại spot dễ cho người mới, spot phần thưởng cao và spot bait mà seeker thường kiểm tra đầu tiên.'],
    ],
    ...
    faqs: [
      ['Meccha Chameleon có chơi online miễn phí không?', 'Có. Bạn có thể chơi thử bằng khung browser phía trên, không cần tải ngay, rồi mở atlas để xem điểm ẩn và màu sơn.'],
      ['Có chơi trên điện thoại được không?', 'Trình duyệt hiện đại có thể mở được, nhưng trải nghiệm đầy đủ vẫn tốt hơn trên PC. Trang này rất hợp để làm màn hình phụ khi chơi.'],
      ['Điểm ẩn tốt là điểm nào?', 'Thường là nơi có nhiều nhiễu thị giác: kệ sách, gạch, gỗ, poster, bóng đổ hoặc vật trang trí khiến silhouette khó bị nhận ra.'],
      ['Đây có phải trang chính thức không?', 'Không. Đây là trang fan-made để chơi nhanh, xem bản đồ, học mẹo ngụy trang và giữ tài liệu khi vào trận.'],
    ],
    secondScreenItems: [
      ['Vào game nhanh', 'Giữ checklist mở sẵn để giảm thời gian chuẩn bị và vào vòng chơi nhanh hơn.'],
      ['Phòng bạn bè', 'Ghi chú về lobby, mã phòng và cách rủ bạn giúp cả nhóm ít phải thử lại.'],
      ['Luyện camo', 'Xem lại màu, bóng, pose và route card trước khi bắt đầu vòng tiếp theo.'],
    ],
  },
  'zh-TW': {
    ...
    newPlayerCards: [
      ['這是什麼遊戲？', 'Meccha Chameleon 是一款 PC 躲貓貓派對遊戲，隱藏者要把身體塗成地圖環境的顏色。'],
      ['這裡可以玩嗎？', '可以。先玩上方瀏覽器遊戲，之後需要對局技巧時再看攻略和地圖圖鑑。'],
      ['值得安裝嗎？', '先快速試玩一局。如果隱藏、塗色和被搜尋的壓力讓你覺得有趣，再把這個攻略開著進入下一局。'],
      ['最先學什麼？', '先學點位選擇、顏色匹配、姿勢控制，以及決定隱藏後保持靜止。'],
    ],
    ...
    faqs: [
      ['可以線上玩 Meccha Chameleon 嗎？', '可以。先從上方瀏覽器遊戲開始，想深入研究對局時再看玩法指南和隱藏點地圖圖鑑。'],
      ['新手第一步該做什麼？', '先玩一小局，再看玩法區：角色基礎、搜尋者習慣、隱藏者站位都會快速講清楚。'],
      ['手機能看這個站嗎？', '可以。瀏覽器遊戲能在現代手機載入，攻略區也適合當作 PC 遊玩時的第二螢幕參考。'],
      ['最好的隱藏點在哪裡？', '看下方地圖圖鑑：每張圖都有點位思路、塗裝顏色、難度標籤和隱藏者提示。'],
    ],
    secondScreenItems: [
