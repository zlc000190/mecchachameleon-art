      ...
      {maps.map((map, index) => (
        ...
        >
          ...
          <div className="p-4">
            ...
            <p className="line-clamp-2 text-xs leading-5 text-[#5d584b]">
              {map.desc}
            </p>

            <div className="mt-3 flex items-center justify-between gap-3 text-xs text-[#5d584b]">
            ...
            <div className="mt-4 grid grid-cols-5 gap-1.5">
              {map.spots.map((spot, sIdx) => (
                <div
                  key={spot.id}
                  className="relative aspect-square overflow-hidden rounded-sm border border-[#ded6c4] bg-[#151512]"
